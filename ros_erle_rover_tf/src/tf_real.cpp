...
void pose2DCallback(const geometry_msgs::Pose2D::ConstPtr& msg)
{
    ...
    msg_to_send.pose.pose.position.z = 0;
    ...
    msg_to_send.pose.pose.orientation.x = q.x();
    msg_to_send.pose.pose.orientation.y = q.y();
    msg_to_send.pose.pose.orientation.z = q.z();
    msg_to_send.pose.pose.orientation.w = q.w();
...
int main(int argc, char* argv[])
{
    ...
    ros::Subscriber sub3 = n.subscribe("pose2D", 10, pose2DCallback);
